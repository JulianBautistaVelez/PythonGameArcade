class GameConstants:
    ...
    CHARACTER_PLAYER = 0
    CHARACTER_NPC = 1
    CHARACTER_PLAYER_MOVEMENT_SPEED = 2.2
    CHARACTER_NPC_MOVEMENT_SPEED = 2
    CHARACTER_EXPLOSIVES_FUSE = 3
    CHARACTER_EXPLOSIVES_COOLDOWN = 1
    ...
    EXPLOSIVES_AOE = 1
    EXPLOSIVES_SPRITE_WIDTH = 256
    EXPLOSIVES_SPRITE_HEIGHT = 256
    EXPLOSIVES_FIRST_SPRITE_SCALE = 0.3
    EXPLOSIVES_COLUMNS = 16
    EXPLOSIVES_COUNT = 60